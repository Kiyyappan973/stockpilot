  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500">Manage your warehouse team members</p>
      </div>

      {/* Invite Code Card */}
      <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
        <h2 className="text-lg font-semibold text-gray-700 mb-2">Invite Code</h2>
